...
class Training_dashboard_controller extends CI_Controller {

    public function __construct() {
        parent::__construct();
        // Your own constructor code
        $this->load->model('training_dashboard_model');
    ...
    public function index(){
        if($this->session->userdata('role')=='' || $this->session->userdata('role')=='Sh-Users'){
            ...
            $data['nav'] = 'pograms';
            $data['subnav'] = 'training';

            $this->load->view('includes/header', $data);
            $this->load->view('training_dashboard');
