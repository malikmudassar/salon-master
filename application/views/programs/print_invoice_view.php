                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <span style="font: normal bold 22px/30px arial, serif; color:#000">RECEIPT</span>
                                   </div>
                                </div>
                                <div class="row" style=" color:#000;">
                                    <div class="col-md-12">
                                        <p><?php echo $program_enrollment[0]['customer_name'];?>, </p>
                                        <p>We hereby confirm the payment as described below</p>
                                        <div class="table">
                                            <table class="table m-t-10" id="tblservices" style="border-bottom:#f7f7f7 1px solid">
                                                <thead style="color:#000 !important">
                                                    <tr>
                                                        ...
                                                        <th>Payment Date</th>
                                                        <th style="text-align: right;">Paid Cash</th>
                                                        <th style="text-align: right;">Paid Card</th>
                                                        <th style="text-align: right;">Paid Check</th>
