<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Enroll Customer in Recurring Payment Plan:</h4>
            </div>
        </div>
        ...
        <div class="row" id="divselection">
            <div class="col-sm-12">
                <div class="card-box ">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>recurring_controller/enroll_customer">
                        <input type="hidden" name="csrf_test_name" id="recurring_customer_csrf" value=""/>
                        <div class="form-group">
                            ...
                            <!----Training Items--->
                             ...
                             <div class="row">
                                <div class="col-lg-12">
                                    <h3 class="title text-primary"><strong>Recurring Payment Plan Related Info:</strong></h3>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                <div class="col-md-6 form-horizontal">
                                    <div class="form-group">
                                        <label for="txtbranches" class="col-md-4 control-label "><span class="text-pink">*</span> Number of Branches</label>
                                        <div class="col-md-8">
                                            <input tabindex="14" type="number" class="form-control" placeholder="1" id="txtbranches" name="txtbranches" required="required" min="1" value="1">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="txtemergencynumber" class="col-md-4 control-label "><span class="text-pink">*</span> Agreed Discount</label>
                                        <div class="col-md-8">
                                            <input tabindex="15" type="text" class="form-control numeric" placeholder="Agreed Discount" id="txtagreeddiscount" name="txtagreeddiscount" required="required" min="0" value="0">
                                        </div>
                                    </div>
                            ...
                            <div class="row m-t-20">
                                <div class="col-md-6">
                                    <div class="btn-group pull-right m-t-15">
                                        ...
                                        <button onclick="$('#recurring_customer_csrf').val($('#cook').val());" class="btn waves-effect waves-light btn-pink m-t-20">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
