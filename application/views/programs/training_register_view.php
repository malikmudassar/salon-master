<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Enroll Customer in Training Program:</h4>
            </div>
        </div>
        ...
        <div class="row" id="divselection">
            <div class="col-sm-12">
                <div class="card-box ">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>training_controller/enroll_customer">
                        <input type="hidden" name="csrf_test_name" id="training_customer_csrf" value=""/>
                        <div class="form-group">
                            ...
                            <!----Training Items--->
                             ...
                             <div class="row">
                                <div class="col-lg-12">
                                    <h3 class="title text-primary"><strong>Training Related Info:</strong></h3>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                <div class="col-md-6 form-horizontal">
                                    <div class="form-group">
                                        <label for="txtemergencyperson" class="col-md-4 control-label "><span class="text-pink">*</span> Emergency Contact Person</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label for="txtemergencynumber" class="col-md-4 control-label "><span class="text-pink">*</span> Emergency Contact Number</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label for="txtgoals" class="col-md-4 control-label">Learning Goals</label>
                                        <div class="col-md-8">
                                            <textarea tabindex="17" type="text" class="form-control" placeholder="Goals" id="txtgoals" name="txtgoals" value="<?php if(isset($customer) && isset($customer[0]['goals'])){ echo $customer[0]['goals'];}?>"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="txteducation" class="col-md-4 control-label ">Last Level of Education Completed</label>
                                        <div class="col-md-8">
                                            <input tabindex="18" type="text" class="form-control" placeholder="Education" id="txteducation" name="txteducation" value="<?php if(isset($customer)&& isset($customer[0]['education'])){ echo $customer[0]['education'];}?>">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="txtlanguages" class="col-md-4 control-label">Languages you can speak</label>                                    
                                        <div class="col-md-8">
                                            <select tabindex="19" id="txtlanguages" name="txtlanguages[]" multiple="multiple" class="form-control" >
                                     ...
                                     <div class="form-group">
                                        <label for="txtbeautyeducation" class="col-md-4 control-label">Previous Beauty Education</label>
                                        <div class="col-md-8">
                                            <input tabindex="20" type="text" class="form-control" placeholder="Beauty Related Education" id="txtbeautyeducation" name="txtbeautyeducation" value="<?php if(isset($customer) && isset($customer['beautyeducation'])){ echo $customer[0]['beautyeducation'];}?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="txtexperience" class="col-md-4 control-label">Previous Beauty Experience</label>
                                        <div class="col-md-8">
                                            <input tabindex="21" type="text" class="form-control" placeholder="Experience" id="txtexperience" name="txtexperience" value="<?php if(isset($customer) && isset($customer[0]['experience'])){ echo $customer[0]['experience'];}?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row m-t-20">
                                <div class="col-md-6">
                                    <div class="btn-group pull-right m-t-15">
                                        ...
                                        <button onclick="$('#training_customer_csrf').val($('#cook').val());" class="btn waves-effect waves-light btn-pink m-t-20">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
