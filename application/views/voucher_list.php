            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            if (isset($voucher_list)) {
                                foreach ($voucher_list as $voucher) {
                                    ...
                                    <tr>
                                        ...
                                        <td class='noprint'>
                                            <a target="_blank" class="btn btn-primary" href="<?php echo base_url('viewvoucher') . "/" . $voucher['id_order_vouchers']; ?>"><span class="fa fa-arrow-right"></span></a>
                                        </td>
                                        <td class='noprint' > 
                                            ...
                                            <?php if(isset($showdelete)){if($showdelete==="Yes"){ ?><button id='btndlt' onclick="javascript:delete_voucher('<?php echo $voucher['id_order_vouchers']; ?>');" class="btn btn-icon waves-effect waves-light btn-danger m-b-5"> <i class="fa fa-trash-o"></i> </button><?php }}?>
                                        </td>
                                    </tr>
                                    <?php
                                }
                        ...
                        $amount = 0;
                        $remaining= 0;
                        foreach ($voucher_list as $total) {

                            $amount+=$total['amount'];
                            $remaining+=$total['remaining_amount'];
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td></td>
                                <td></td> 
                                <td><strong><?php echo $amount ? $amount : 0; ?></strong></td>
                                <td><strong><?php echo $remaining ? $remaining : 0; ?></strong></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
