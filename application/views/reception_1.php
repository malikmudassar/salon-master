            ...
            <div class="col-md-8">
                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="visit-category" class="control-label">Select Category</label>
                                <select class='form-control' id="visit-category" name="visit-category" onchange="getservices($(this).val());"> 
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class='form-control' id="visit-services" name="visit-services" onchange="getserviceproducts($(this).val());"> 
        ...
        <div class="row" id="divorder" style="display:none;">
            <div class="col-md-8">
                ...
                <div class="card-box">
                    ...
                    <div class="row" style="text-align: right">
                        <?php echo form_open('open_order_invoice'); ?>
                                        ...
                                        <div id="voucher-price-div" style="display: none;">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="voucher-price" name="voucher-price" class="form-control" type="text" placeholder="Amount">
                                                </div>
                                            </div>
                                        </div>
            ...
            function getcategories() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var chtml = '<option value="select">Select</option>';
                        ...
                        for (x = 0; x < data.length; x++) {
                            ...
                            chtml += '<option value="'+id+'">'+name+'</option>';

                        }

                        $('#visit-category').append(chtml);

                    }
                });
            }

            function getservices(id_service_category) {
...
//                }
            ...
            function fillvisit(visitid, qtype) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#visit-date").val(data[0]['visitdate']);
                        mhtml = "";
                        for (x = 0; x < data.length; x++) {
                            mhtml += '<tr>';
            ...
            function addServiceRows() {
                ...
                if($('#visit-category option:selected').val() === 'select' || $('#visit-services option:selected').val() === 'select'){
                    swal({
                        title: "Mandatory (*) fields not selected!",
                        text: 'Please select all mandatory fields with (*) sign.',
                        type: "info",
                        confirmButtonText: 'OK!'
                    });
                    return false;
                ...
                if ($("#visit-services option:selected").val() !== 'select' && $('#visit-staff option:selected').text() != "") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (x = 0; x < data.length; x++) {
                            ...
                            chtml += '<li data-service_category_id="'+id+'" onclick="giftVoucherSubServices('+id+', '+category_name+');">'+name+'</li>';
            ...
            function generateGiftVoucher(){
                ...
                var post_data = 'service_names=' +service_names+ '&service_ids=' +service_ids+ '&price=' +price+ '&type=' +type+ '&customer_id=' +customer_id+ '&valid_until=' +valid_until;
