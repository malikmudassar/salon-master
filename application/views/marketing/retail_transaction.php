                        ...
                        <div class="row">
                            ...
                            <div class="pull-right m-t-20" >
                                <div class="col-md-9 hidden-print m-t-20">
                                    <form method="POST" action='<?php echo base_url(); ?>retail-transaction'>
...
<!--                                    <a class="btn btn-warning m-l-10" href="<?php //echo base_url('marketing_controller/marketing_excell'.'/'.$date);                                            ?>" style="float:right">Export to Excel</a>
                        ...
                        <div class="row">
                            <table class="table m-t-10 table-bordered"  id='sheet1'>
                                <tr>
                                    <td colspan="7"><strong>Retail Transaction </strong></td>
                                </tr>
                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($retailTransaction) && !empty($retailTransaction)) {
                                                    ...
                                                    foreach ($retailTransaction as $data) {
                                                        ...
                                                        if (isset($data['data']) && !empty($data['data'])) {
                                                                    ...
                                                                    <td class="text-right">
                                                                        <?php if ($row['price'] - $row['purchase_price'] > 0) { ?>
                                                                            <span class="text-primary"><?php
                                                                                $total_profit += $row['price'] - $row['purchase_price'];
                                                            ...
                                                            $grand_total_discont += $total_discont;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><strong><?php echo number_format($total_discont, 2); ?></strong></td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><strong><?php echo number_format($grand_total_discont, 2); ?></strong></td>
