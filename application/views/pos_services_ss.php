<?php if(isset($id_customer_visit)){
     
    $dt = explode("T", $openvisitservices[0]['visit_service_start']);
    $customerid = $openvisit[0]['id_customers'];
    $customername=$openvisit[0]['customer_name'];
    $customercell=$openvisit[0]['customer_cell'];
    $customeremail=$openvisit[0]['customer_email'];
    $customeraddress=$openvisit[0]['customer_address'];
    $visitid = $openvisit[0]['id_customer_visits'];
    $advancecomment = $openvisit[0]['advance_comment'];
}?>
            ...
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15 clear-fix">
                    <form style="display:inline-block" id="retailform" method="Post" action="<?php echo base_url();?>pos_view">
                        ...
                        <input id="retailcustomer" name="customerid" type="hidden" value="<?php if(isset($customerid)){echo $customerid;} ?>"/>
                ...
                <?php if (isset($totalinvoices)){?>
                    <h4 class="page-title">Invoices Created server side: <span id="totalvisits" class="page-title"><?php echo $totalinvoices->invoices; ?></span></h4>
                <?php } else { ?>
                    <h4 class="page-title">Point of Sale (Services server side): </h4>
                <?php } ?>
            </div>
        </div>
        <!--End Page Title-->
                    ...
                    <div class="row" > <!--style="border:1px solid #e3e3e3; border-radius: 4px;"-->
                        <div class="col-md-12">
                            <div class="col-md-4 m-t-10">
                                ...
                                <p><b>Customer: <label class="text-primary" id='label-customer-name'><?php if(isset($customername)){echo $customername;} ?></label></b></p>
                                ...
                                <p><b>Visit ID: <input style="border:none;" name="visitid" id="visitid" type="text" readonly="readonly" value="<?php if(isset($visitid)){echo $visitid;} ?>"/></b></p>
                                <p><b>Visit Date: <input style="border:none;" name="visitdate" id="visitdate" type="text" readonly="readonly" value="<?php if(isset($dt)){echo $dt[0].' '.$dt[1];} ?>"/></b></p>
                            </div>
                            <div class="col-md-4 m-t-10 hidden-print" id="CurrentActionDiv" style="border:1px solid #f7f7f7; background: #797979 ;padding:25px 10px !important">
                                ...
                                <form id="opendirectselect" action="<?php base_url('pos_services');?>" method="post">
                                    ...
                                    <input name="customerid" id="customerid" type="hidden" value="<?php if(isset($customerid)){echo $customerid;} ?>">
                                </form>
                                <input name="customername" id="customername" type="hidden" value="<?php if(isset($customername)){echo $customername;} ?>">
                                <input name="customercell" id="customercell" type="hidden" value="<?php if(isset($customercell)){echo $customercell;} ?>">
                                <input name="customeremail" id="customeremail" type="hidden" value="<?php if(isset($customeremail)){echo $customeremail;} ?>">
                                <input name="customeraddress" id="customeraddress" type="hidden" value="<?php if(isset($customeraddress)){echo $customeraddress;} ?>">
                                
                                <input name="txtinvoiceid" id="txtinvoiceid" type="hidden" value="<?php if(isset($invoiceid)){echo $invoiceid;} ?>"/>
                                ...
                                <span id="CurrentAction" style="font-size:21px; color:#fff; padding-left: 20px;" >Waiting . . . </span>
                            ...
                            <div class="row m-t-10" style="padding:10px;">        
                                <div class="col-md-2 col-sm-10">
                                    <div class="form-group ">
                                        <input  type="text" <?php if(isset($id_customer_visit) || isset($id_customer)){echo 'disabled="disabled"';} ?> id="txt-customer-search" name="txt-customer-search" onchange='on_customer_change();' placeholder="Select Customer"  class="form-control" >
                                    </div>
                                </div>

                                <div class="col-md-1 col-sm-2">
                                    <div class="form-group ">
                                        <button <?php if(isset($id_customer_visit) || isset($id_customer)){echo 'disabled="disabled"';} ?> id="btnaddcustomer" type="button" onclick="openaddnew();" class="btn btn-pink btn-sm m-t-5" >Add</button>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <div class="form-group ">
                                        <select class='form-control' onchange="on_staff_change();" multiple="multiple" placeholder="Select Staff" id="visit-staff" name="visit-staff[]" >
                                ...
                                <div class="col-md-1 col-sm-12">
                                    <div class="input-group">
                                        <div class="bootstrap-timepicker">
                                            <input id="visit-time" onchange='onVisitTimeChange();' data-date-format="HH:mm" data-date-useseconds="false" type="text" class="form-control" value="<?php if(isset($dt)){echo $dt[1];}?>">
                                        </div>
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" onchange='onVisitDateChange();' class="form-control" placeholder="mm/dd/yyyy" id="visit-date" value="<?php if(isset($dt)){echo $dt[0];}?>">
                                        ...
                                        <table class="table m-t-10" id="tblservices">
                                            ...
                                            <tbody>
                                                <?php if(isset($id_customer_visit)){ 
                                                    ...
                                                    $x=0;
                                                    foreach($openvisitservices as $service){ $x++;?> 
                                                
                                                    <tr class="service_row">
                                                    <td class="id" row_id='<?php echo $x?>'><?php echo $x?> </td>
                                                    <td row_id='<?php echo $x?>' class="tdservicecategory hidden-print"><?php echo $service['service_category'];?></td>
                                                    <td>
                                                        <input type="hidden" id="service_ids" name="service_ids" row_id='<?php echo $x?>' id_visit_services='<?php echo $service['id_visit_services'];?>' service_type='<?php echo $service['service_type'];?>' service_category="<?php echo $service['service_category']; ?>"  service_name="<?php echo $service['service_name'];?>" service_duration="<?php echo $service['service_duration'];?>" flag="<?php echo $service['service_flag']; ?>" id_service_category="<?php echo $service['id_service_category'];?>" visit_service_start="<?php echo $service['visit_service_start'];?>" commission="<?php echo $service['commission_perc'];?>" value="<?php echo $service['id_business_services'];?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        $y=0;
                                                        $scount=0;
                                                        foreach($openvisitstaffs as $staff){
                                                            foreach($openvisitstaffs as $staff1){
                                                                if($service['id_visit_services'] == $staff1['visit_service_id']){
                                                                    $scount++;
                                                                }
                                                            }
                                                            ...
                                                            if($service['id_visit_services'] == $staff['visit_service_id']){
                                                               $checked='';
                                                               if($staff['requested']=="Yes"){$checked=' checked="checked" ';} ?>
                                                               <div class="checkbox checkbox-primary">
                                                                   <input class="hidden-print" row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>' staff_id='<?php echo $staff['staff_id'];?>' staff_name="<?php echo $staff['staff_name'];?>" id="requested_<?php echo $x; ?>_<?php echo $service['id_business_services'];?>_<?php echo $staff['staff_id'];?>" type="checkbox" name="requested" <?php echo $checked;?> />
                                                                   <label onclick="changestaff('<?php echo $x;?>','<?php echo $service['id_business_services'];?>','<?php echo $service['staff_id']?>');" id="requested_<?php echo $x;?>_<?php echo $service['id_business_services'];?>_<?php echo $staff['staff_id'];?>_label"> <?php echo $staff['staff_name']?></label>
                                                                   <input class="form-control staffshare hidden-print" onchange="calcstaffshare('<?php echo $x;?>','<?php echo $service['service_rate'];?>','<?php echo $staff['staff_id'];?>', 'staffshare_<?php echo $x;?>_<?php echo $service['id_business_services'];?>_<?php echo $staff['staff_id'];?>')" style="width:80px; height:18px; display:inline; float:right; text-align:right;" id="staffshare_<?php echo $x;?>_<?php echo $service['id_business_services'];?>_<?php echo $staff['staff_id'];?>" name="staff_share" row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>' staff_id='<?php echo $staff['staff_id'];?>' servicerate='<?php echo $service['service_rate'];?>' value="<?php echo $service['service_rate']/$scount;?>">
                                                               </div>
                                                               <?php 
                                                            }
                                                            $scount=0;
                                                    ...
                                                    <!--Products-->
                                                    <select multiple="multiple" style="border:none;" class="serviceproducts" id="serviceproducts_<?php echo $x;?>_<?php echo $service['id_business_services'];?>" name="id_business_products">
                                                    <?php 
                                                    
;                                                    $selected = '';
                                                    foreach($serviceproducts as $products){
                                                        foreach($products as $serviceproduct){
                                                            if($serviceproduct['business_service_id'] == $service['id_business_services']){
                                                                foreach($openvisitserviceproducts as $vsp){
                                                                    if($vsp['visit_service_id'] == $service['id_visit_services'] && $vsp['product_id']==$serviceproduct['id_business_products']){                                            
                                                                        $selected = 'selected="selected"';
                                                                   } 
                                                                }?>
                                                                <option row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>' service_name="<?php echo $service['service_name'];?>" product_service_id="<?php echo $serviceproduct['id_services_products'];?>" unit="<?php echo $serviceproduct['measure_unit'];?>" qty="<?php echo $serviceproduct['usage_qty'];?>" product_name="<?php echo $serviceproduct['product'];?>" value="<?php echo $serviceproduct['id_business_products'];?>" <?php echo $selected;?>><?php echo $serviceproduct['product'];?></option>
                                                                <?php 
                                                            }       
                                                        }
                                                    }?>
                                                    ...
                                                    <?php 
                                                    if($service['loyalty_service'] == 'N'){?>
                                                    <td class="discount discountshow hidden-print">
                                                        <div class="col-lg-12">
                                                            <div class="form-inline">
                                                                <input row_id='<?php echo $x;?>' service_id='<?php echo  $service['id_business_services'];?>'  readonly ondblclick="$('#invoicepass').modal('show');" onclick="enable_discount_pass('<?php echo $x;?>', '<?php echo $service['id_business_services'];?>')" style="border:none; width: 40px;" onkeyup="javascript:discount_by_service(0, '<?php echo $x;?>', '<?php echo $service['id_business_services'];?>');" class="numeric discount_by_service discount" type="text" name="discount_by_service" id="discount_by_service_<?php echo $x;?>_<?php echo $service['id_business_services']?>" placeholder="0"  />'
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="discountperc discountshow hidden-print">
                                                        <div class="col-lg-12">
                                                            <div class="form-inline">
                                                                <input row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>'  readonly ondblclick="$('#invoicepass').modal('show');" onclick="enable_discount_pass('<?php echo $x;?>', '<?php echo  $service['id_business_services'];?>');" style="border:none; width: 40px;" onkeyup="javascript:perc_discount_service(0, '<?php echo $x;?>', '<?php echo $service['id_business_services'];?>');" class="numeric perc_discount_service discount" type="text" name="perc_discount_service" id="perc_discount_service_<?php echo $x;?>_<?php echo $service['id_business_services'];?>" placeholder="0"  />'
                                                            </div>
                                                        </div>
                                                    </td>
                                                    
                                                    <td class="discountshow hidden-print"><div class="col-lg-12"><div class="form-inline">
                                                        <select class="form-control" name="discount_type" row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>'  id="discount_type_<?php echo $x;?>_<?php echo  $service['id_business_services'];?>">
                                                            <option id=""></option>
                                                    ...
                                                    <td >Rs.<span class="combat" name="unitcost" row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>' id="unitcost_<?php echo $x;?>_<?php echo $service['id_business_services'];?>'"><?php echo $service['service_rate'];?></span>
                                                        <input type="hidden" name="orignal_service_rate" row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>'  id="orignal_service_rate_<?php echo $x;?>_<?php echo $service['id_business_services'];?>" value="<?php echo $service['service_rate'];?>" />
                                                    </td>
                                                <?php } else { ?>
                                                    <td class="hidden-print"></td><td class="hidden-print"></td><td class="hidden-print"></td>
                                                    <td >Rs.<span class="combat" name="unitcost" id="unitcost_<?php echo $x;?>_<?php echo $service['id_business_services'];?>">0.00</span>
                                                        <input type="hidden" name="orignal_service_rate" row_id='<?php echo $x;?>' service_id='<?php echo $service['id_business_services'];?>' id="orignal_service_rate<?php echo $service['id_business_services'];?>" value="0.00" /></td>
                                                <?php } ?>                    

                                                <td class="hidden-print"><span class="label label-danger" onclick="removebyrow('<?php echo $x;?>');" style="cursor:pointer">x</span></td>
                                                <?php }} ?>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 hidden-sm hidden-xs">
                                    <div class="row hidden-print">
                                        <div class="col-md-12">
                                            <h4>Remarks:</h4>
                                            <div class="form-group">
                                                <textarea row="5" class="form-control" id="txtinvoiceremarks" name="txtinvoiceremarks" value="<?php if(isset($advancecomment)){echo $advancecomment;}?>"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 ">
                                    <p class="text-right"><b>Sub-total:</b>   Rs. <input id="txtsubtotal" class="form-inline" readonly="readonly" style="text-align: right; width: 80px; border: none;" value='0'></p>
...
//        
    ...
    function onVisitTimeChange(){
        ...
        if($("#visitid").val()!=="" && $("#btninvoice").is(':visible')){
            visit_mode();
        }
                ...
                for (x = 0; x < services.length; x++) {
                    ...
                    for(y=0; y < staffs.length;y++){
                        if(services[x].id_visit_services == staffs[y].visit_service_id){
                           ...
                           mhtml += '<div class="checkbox checkbox-primary"><input class="hidden-print" row_id='+rowcount+' service_id='+services[x].id_business_services+' staff_id=' + staffs[y].staff_id + ' staff_name="' + staffs[y]['staff_name'] + '" id="requested_' + rowcount + '_' + services[x].id_business_services +  '_' + staffs[y]['staff_id'] +'" type="checkbox" name="requested" '+ checked +'/><label onclick="changestaff('+rowcount + ',' + services[x].id_business_services + ',' + services[x].staff_id + ');" id="requested_' + rowcount + '_' + services[x].id_business_services +  '_' + staffs[y]['staff_id'] + '_label">' + staffs[y].staff_name + '</label>';
...
//                                            console.log('service visit id '+  services[x].id_visit_services);
                    ...
                    if(services[x].loyalty_service =='N'){
                        ...
                        mhtml += '<input row_id='+rowcount+' service_id='+ services[x].id_business_services +'  readonly ondblclick="$(\'#invoicepass\').modal(\'show\');" onclick="enable_discount_pass('+rowcount + ', ' + services[x].id_business_services + ')" style="border:none; width: 40px;" onkeyup="javascript:discount_by_service(0, '+rowcount + ', ' + services[x].id_business_services + ');" class="numeric discount_by_service discount" type="text" name="discount_by_service" id="discount_by_service_' +rowcount+'_'+ services[x].id_business_services + '" placeholder="0"  />';
                        mhtml += '</div></div></td>';
                        mhtml += '<td class="discountperc discountshow hidden-print"><div class="col-lg-12"><div class="form-inline">';
                        mhtml += '<input row_id='+rowcount+' service_id='+ services[x].id_business_services +'  readonly ondblclick="$(\'#invoicepass\').modal(\'show\');" onclick="enable_discount_pass('+rowcount + ', '+ services[x].id_business_services + ');" style="border:none; width: 40px;" onkeyup="javascript:perc_discount_service(0, '+rowcount + ', '+ services[x].id_business_services +');" class="numeric perc_discount_service discount" type="text" name="perc_discount_service" id="perc_discount_service_' +rowcount+'_'+ services[x].id_business_services+'" placeholder="0"  />';
                        mhtml += '</div></div></td>';
                        ...
                        mhtml += '<td >Rs.<span class="combat" name="unitcost" row_id='+rowcount+' service_id='+ services[x].id_business_services +' id="unitcost_'+rowcount+'_'+services[x].id_business_services+'">'+services[x].service_rate+'</span><input type="hidden" name="orignal_service_rate" row_id='+rowcount+' service_id='+ services[x].id_business_services +'  id="orignal_service_rate_'+rowcount+'_'+services[x].id_business_services+'" value="'+services[x].service_rate+'" />';
                        mhtml += '</td>';
                    } else { 
                        mhtml += '<td class="hidden-print"></td><td class="hidden-print"></td><td class="hidden-print"></td>';
                        mhtml += '<td >Rs.<span class="combat" name="unitcost" id="unitcost_'+rowcount+'_'+services[x].id_business_services+'">0.00</span><input type="hidden" name="orignal_service_rate" row_id='+rowcount+' service_id='+ services[x].id_business_services +' id="orignal_service_rate'+services[x].id_business_services+'" value="0.00" /></td>';
                    }                    
        ...
        $.each($(".service_row"), function(){
            ...
            $.each($(this).find('.staffshare'), function(){
                if($(this).attr('row_id')===row_id){
                    var xx=$(this).attr('servicerate')/servicestaff;
                    console.log(xx);
                    console.log($(this).val());
                    if($(this).attr('staff_id')!==staff_id && $(this).val() == xx){
                        $(this).val(price/(servicestaff-1));
                        console.log('ans'  + price/(servicestaff-1));
                    }
    ...
    function addServiceRows(service_products) {
        ...
        mhtml += '<td style="">';
            $('#visit-staff').children('option:selected').each(function() {
                ...
                mhtml += '<div class="checkbox checkbox-primary"><input id="staff_ids' + rowcount + '_' + $(this).val() + '" type="checkbox" name="requested" row_id='+ rowcount +' service_id='+ data['id_business_services'] +' staff_id=' + $(this).val() + ' staff_name="'+ $(this).text() +'"  /><label for="staff_ids' + rowcount + '_' + $(this).val() + '">'+$(this).text() + '</label></div>';
...
//        mhtml += '</select></div></div></td>';
        ...
        mhtml += '<td >Rs.<span class="combat" id="unitcost_'+rowcount+'_'+data['id_business_services']+' row_id='+ rowcount +' service_id='+data['id_business_services']+' ">'+data['service_rate']+'</span><input type="hidden" name="orignal_service_rate" id="orignal_service_rate'+data['id_business_services']+'" value="'+data['service_rate']+'" />';
        mhtml += '</td>';
    ...
    function pickstaff(staff_id, staff_name){
        ...
        var l = $(replacementelement+'_label').attr('onclick').split(',');
        $(replacementelement+'_label').attr('onclick',l[0]+','+l[1]+','+staff_id+')');
