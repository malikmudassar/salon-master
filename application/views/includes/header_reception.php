...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Custome build CRM, CMS, for your SPA, PARLOR & SALON.">
                ...
                <div class="container">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li class="active">
                                <a href="<?php echo base_url(); ?>dashboard" class="active"><i class="zmdi zmdi-view-dashboard"></i> <span> Reception </span> </a>
                            </li>
                            <li>
                               <a href="<?php echo base_url(); ?>todayinvoices" class="active"><i class="zmdi zmdi-collection-text"></i> <span> Invoices </span> </a>
                            </li>                            
