    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Account Vouchers (<?php echo $business[0]['business_name'];?>):</h4>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card-box ">
                    ...
                    <div class="row m-b-10" id="div-filters">
                        ...
                        <div class="row">
                            <form method="post" action="<?php echo base_url();?>account_vouchers">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <input type="hidden" name="dateselected" id="dateselected" value="">
                                </div>
                                <div class="col-lg-2"><button type="submit" onclick="$('#accounting_voucher_csrf').val($('#cook').val()); $('#dateselected').val('Voucher');" class="btn btn-pink btn-bordred waves-effect w-md waves-light m-b-5">Voucher Date</button></div>
                                <div class="col-lg-2"><button type="submit" onclick="$('#accounting_voucher_csrf').val($('#cook').val()); $('#dateselected').val('Create');" class="btn btn-pink btn-bordred waves-effect w-md waves-light m-b-5">Create Date</button></div>
                                <div class="col-lg-2"><i id="cog" class="fa fa-spin fa-cog" style="display:none; font-size:26px;width: auto;margin-right: 10px;"></i></div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php $last=""; $debit=0; $credit=0; foreach($account_vouchers as $account_head){ ?>
                                    <tr>
                                        <?php  if($last!==$account_head['id_account_vouchers']){?>
                                            ...
                                            <td style="border-top:1px solid #000"><?php echo $account_head['created_on']; ?></td>
                                            ...
                                            <td style="border-top:1px solid #000; text-align: right; font-weight: bold;" class="text-success"><?php echo $account_head['debit']; $debit=$debit+$account_head['debit']; ?></td>
                                            <td style="border-top:1px solid #000; text-align: right; font-weight: bold;" class="text-success"><?php echo $account_head['credit']; $credit=$credit+$account_head['credit'];?></td>
                                            <td style="border-top:1px solid #000" class='noprint'> 
                                                <form method="post" action="<?php echo base_url(); ?>accounting_controller/accountvoucheredit">
                                                    ...
                                                    <button id="voucher_acount_id" onclick="account_voucher_remove(<?php echo $account_head['id_account_vouchers'];?>);" class="btn btn-icon waves-effect waves-light btn-danger m-b-5"><i class="fa fa-trash"></i></button></td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td class="text-success" style="text-align: right; font-weight: bold;"><?php echo $account_head['debit']; $debit=$debit+$account_head['debit']; ?></td>
                                            <td class="text-success" style="text-align: right; font-weight: bold;"><?php echo $account_head['credit']; $credit=$credit+$account_head['credit']; ?></td>
                                            <td></td>
...
//        console.log(startdate.format('YYYY-MM-DD') + ' ' + enddate.format('YYYY-MM-DD'));
        voucher_list($("#startdate").val(), $('#enddate').val());
...
//        }
  ...
  //      console.log(startdate.format('YYYY-MM-DD') + ' ' + enddate.format('YYYY-MM-DD'));
        create_list($("#startdate").val(), $('#enddate').val());
    ...
    function voucher_list(start = null, end = null) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url();?>accounting_controller/get_vouchers',
            data: {startdate: startd, enddate: endd, voucher_type: $('#voucher_type').val()},
            dataType: "json",
            cache: false,
            async: true,
            success: function(data) {
                ...
                var hhtml = "<tr><th>ID</th><th>Description</th><th>Cost Center</th><th>Business Partner</th><th>Voucher Date</th><th>Created By</th><th>Created On</th><th>Debit</th><th>credit</th><th class='hidden-print noprint'>Action</th></tr>"
    ...
    function create_list(start = null, end = null) {
        var startd = start ? start : moment(startdate).format('YYYY-MM-DD');
        var endd = end ? end : moment(enddate).format('YYYY-MM-DD');
        $("#cog").show();
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url();?>accounting_controller/get_vouchers_created',
            data: {startdate: startd, enddate: endd, voucher_type: $('#voucher_type').val()},
            dataType: "json",
            cache: false,
            async: true,
            success: function(data) {
                ...
                var hhtml = "<tr><th>ID</th><th>Description</th><th>Cost Center</th><th>Business Partner</th><th>Voucher Date</th><th>Created By</th><th>Create On</th><th>Debit</th><th>credit</th><th class='hidden-print noprint'>Action</th></tr>"
