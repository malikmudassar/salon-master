    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    ...
                    <button id="btnServicesDashboard" class="btn btn-warning  waves-effect waves-light">Services Dashboard</button>
                </div>
                ...
                <h4 class="page-title">Retail Dashboard</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
               <div class="card-box">
                  <h4 class="header-title m-t-0 m-b-5">Today&#8216;s Retail Revenue</h4>
                ...
                <div class="card-box">
                    ...
                    <div class="widget-chart-1">
                        ...
                        <div class="widget-detail-1">
                            ...
                            <p class="p-t-5 m-b-0">Bank: <span id="monthloyalty">0</span></p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card-box">
                   <h4 class="header-title m-t-0 m-b-30">This Year's Retail Revenue</h4>
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1">
                            <span id="monthlysale" ></span>
                        </div>
                        <div class="widget-detail-1">
                            <h2 class="p-t-10 m-b-0" id='yearrevenue'> 0 </h2>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card-box">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">Product Purchases</h4>

                    <div class="widget-box-2">
                        <div class="widget-detail-2">
                            <span class="badge badge-custom pull-left m-t-20"> <i
                                    class="zmdi zmdi-account-box-mail"></i> </span>

                            <h2 class="m-b-0" id="salescommissions"> 0 </h2>
       ...
       <div class="row" >
                    <div class="col-lg-4">
                        <div class="card-box">
                            <h4 class="header-title m-t-0 m-b-30">Top 20 Retail Customers of <span id="customermonthname"></span></h4>
                    ...
                    <div class="col-lg-8">
                        <div class="card-box">
                            <h4 class="header-title m-t-0 m-b-30">Staff Retail this Month </h4>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnServicesDashboard').on('click', function(){
        ...
        $('#container').highcharts({
            ...
            credits: false,
            colors: ['#71b6f9' ,'#ff8acc', '#59a9f8 ', '#4a59b4', '#f9c851', '#10c469', '#ff5b5b', '#7cb5ec', '#434348', '#90ed7d', '#f7a35c', '#8085e9', 
                '#f15c80', '#e4d354', '#2b908f', '#f45b5b', '#91e8e1'],
            title: {
                text: 'Total Retail Revenue'
            },
            xAxis: {
                categories: [
                    'Jan', 'Feb', 'Mar',
    ...
    function draw_grossing_services(mData, total){
        ...
        Highcharts.getOptions().plotOptions.pie.colors = (function () {
            var colors = [],
                base = '#71b6f9',//Highcharts.getOptions().colors[0],
                i;
...
//                '#f15c80', '#e4d354', '#2b908f', '#f45b5b', '#91e8e1'],
            title: {
                text: '10 Highest Grossing Products'
            },
            subtitle: {
                text: 'Percentages of Rs.'+ total.toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ",") + ' made by the top 10 Products this month.'
            },
            plotOptions: {
                series: {
                    dataLabels: {
    ...
    function todayssaleold(){
        var yesterday=0;
        var today=0;
        $.ajax({
                type: "POST",
                url: "retaildashboard_controller/todayssale",
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/yesterdaysale",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: false,
        ...
        $("#todayperc").html('<div class="progress-bar progress-bar-custom" role="progressbar" aria-valuenow="'+ Math.round(perc) +'" aria-valuemin="0" aria-valuemax="100"style="width: ' +Math.round(perc)+ '%;"><span class="sr-only">'+Math.round(perc)+'% Complete</span></div>');
    }
    ...
    function monthsale(){
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/monthsale",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
    ...
    function yearsale(){
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/yearsale",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
    ...
    function monthlysale(){
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/monthlysale",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
    ...
    function dailysale(){
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/dailysale",
            dataType: "json",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            cache: false,
            async: true,
    ...
    function get_month_commission(){
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/get_month_commission",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
            success: function(data) {
                ...
                cmonth='';
                for (x = 0; x < data.length; x++) {
                    mhtml = mhtml + parseInt(data[x]['purchases']);
                    
                } 
                 $("#salescommissions").html(formatDollar(parseInt(mhtml)));
                 $("#commissionsmonth").html($("#selectmonth option:selected").text());
            }
    ...
    function top_4_clients(){
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/top_4_clients",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
    ...
    function top_4_staff(){
            $.ajax({
            type: "POST",
            url: "retaildashboard_controller/top_4_staff",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
            success: function(data) {
                ...
                for (x = 0; x < data.length; x++) {
                    ...
                    mhtml+='<td><span class="label label-default">'+ data[x]['qty'] +'</span></td>';
    ...
    function grossing_services(){
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/grossing_services",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
    ...
    function formatDollar(num) {
     ...
     function getmonthbreakup(){
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/get_months_breakup",
             data:{month: $("#selectmonth option:selected").val(), year: $("#selectyear option:selected").val()},
            dataType: "json",
            cache: false,
            async: true,
     ...
     function todayssale(){
        ...
        $.ajax({
            type: "POST",
            url: "retaildashboard_controller/get_today_breakup",
            data:{param:'none'},
            dataType: "json",
            cache: false,
            async: true,
            success: function(data) {
                console.log(data);
                   if(data['cash'].length>0){
                    ...
                    $("#todayrevenue").html(formatDollar(today));
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            console.log(data);
                            if(data.length>=1){
                                yesterday = parseFloat(data[0]['Total']);
                            } 
                        }
                    });
                    ...
                    console.log(difference);
                    var perc= 0;
                    if(yesterday >0) {perc=(100*difference)/yesterday;}
                    else {perc= 100;};
                    console.log(today+'-'+ yesterday + '=' +difference);
                    if (difference > 0){
                        $("#todayincrease").html(perc.toFixed(1) + ' % <i class="zmdi zmdi-trending-up"></i>');
                    } else if (difference < 0){
                        $("#todayincrease").html(perc.toFixed(1) + ' % <i class="zmdi zmdi-trending-down"></i>');
