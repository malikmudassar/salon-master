    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title" > Loyalty Services</h4>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php if(isset($service_loyalty)) { foreach ($service_loyalty as $sl){ ?>
                            <tr>
                                ...
                                <td class='noprint' > 
                                    <?php echo form_open('products', 'style="display:inline"');?>
                                    ...
                                    <button class="btn btn-warning waves-effect waves-light m-b-5"> 
                                        <i class="fa fa-cloud m-r-5"></i> <span> s </span> 
                                    </button> 
                                    </form>
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (result[0] === "success") {
                                swal("Deleted!", "Brand and all its s have been removed.", "success");
                                location.reload();
                            } else {
