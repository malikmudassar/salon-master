        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <button id="btnSaleDashboard" class="btn btn-warning waves-effect waves-light">Services Dashboard</button>
        ...
        <div class="row" >
            ...
            <div class="col-lg-8">
                <div class="card-box">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">Un-Invoiced Customer Visits</h4>
...
<?php echo $sales; ?>
            ...
            function drawyourmonth() {
                ...
                var advance = <?php echo json_encode($mAdvance); ?>;
            ...
            function monthsale() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        //console.log(data);
                        //if (data.length >= 1) {
                            monthsale = parseFloat(data['invoice'][0].Total) +  parseFloat(data['advance'][0].Total) + parseFloat(data['voucher'][0].Total)     ;
            ...
            function grossing_services() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo base_url(); ?>dashboard_controller/grossing_services",
                    data: {},
                    dataType: "json",
                    cache: false,
                    async: true,
