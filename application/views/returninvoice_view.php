                            ...
                            <div class="panel-body">
                                                            ...
                                                            <td>
                                                                <div class="col-lg-12">
                                                                    <div class="form-inline">
                                                                        <input  onclick="single_discount_pass('<?php echo $service['id_business_services']; ?>');" style="border:none; width: 40px;" onkeyup="javascript:discount_by_service(this.value, '<?php echo $service['id_business_services']."_".$x; ?>');" class="numeric discount_by_service" type="text" name="discount_by_service" id="discount_by_service<?php echo $service['id_business_services']."_".$x; ?>" placeholder="0" readonly="readonly"  />                                                                    
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="hidden-print">
                                                                <div class="col-lg-12">
                                                                    <div class="form-inline">
                                                                        <input  onclick="single_discount_pass('<?php echo $service['id_business_services']; ?>');" style="border:none; width: 40px;" onkeyup="javascript:perc_discount_service(this.value, '<?php echo $service['id_business_services']."_".$x; ?>');" class="numeric perc_discount_service" type="text" name="perc_discount_service" id="perc_discount_service<?php echo $service['id_business_services']."_".$x; ?>" placeholder="0" readonly="readonly" />
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="hidden-print">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-3">
                                        <?php if($service['loyalty_service']=='N'){?>
                                        <p class="text-right"><b>Sub-total:</b>   Rs. <input id="txtsubtotal" class="form-inline" readonly="readonly" style="width: 80px; border: none;" value='<?php echo number_format((float)$subtotal, 2, '.', '');?>'></p>
                                        ...
                                        <?php } else { ?>
                                        <p class="text-right"><b>Sub-total:</b>   Rs. <input id="txtsubtotal" class="form-inline" readonly="readonly" style="width: 80px; border: none;" value='0.00'></p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" value="Refill" name="txt_full_set_refill" id="txt_full_set_refill3"> Removal
                                                </label>
                                            </div> 
                                        </div> 
                                    </div>
...
//        }
    ...
    function perc_discount_service(discount, idservices) {
        ...
        discount_by_service(discount, idservices);
